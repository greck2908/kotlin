...
object LiteKonanLibraryInfoProvider {
    ...
    fun getDistributionLibraryInfo(rawPath: String): LiteKonanLibrary? {
        ...
        val name = manifestProperties["unique_name"]?.toString() ?: return null
        val fullVersion = manifestProperties["compiler_version"]?.toString() ?: return null
        val shortVersion = fullVersion.substringBefore('-')

        return LiteKonanLibrary(libraryPath, name, fullVersion, shortVersion, platform)
    }
}
